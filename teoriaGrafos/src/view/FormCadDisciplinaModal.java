...
public class FormCadDisciplinaModal extends javax.swing.JDialog {
    ...
    */
    ...
    public FormCadDisciplinaModal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCadDisciplinaModal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormCadDisciplinaModal dialog = new FormCadDisciplinaModal(new javax.swing.JFrame(), true);
