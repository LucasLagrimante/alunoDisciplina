...
public class FormCadAlunoModal extends javax.swing.JDialog {

    private Aluno aluno;
   
            
    public FormCadAlunoModal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        aluno = new Aluno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCadAlunoModal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormCadAlunoModal dialog = new FormCadAlunoModal(new javax.swing.JFrame(), true);
